...
├── mistral_fewshot-nocot-stage2.py
├── mistral_zeroshot-cot-stage2.py
├── mistral_zeroshot-nocot-stage2.py
├── monitor_gpu.sh
├── output-stage1
│   ├── claude_20240805001059.log
│   └── claude_results_20240805001059.json
├── output-stage2-fewshot-cot
│   ├── mistral_20240808161940.log
│   ├── mistral_20240808161946.log
│   ├── mistral_20240808161952.log
│   ├── mistral_20240808161959.log
│   ├── mistral_20240808162007.log
│   ├── mistral_results_20240808161940.json
│   ├── mistral_results_20240808161946.json
│   ├── mistral_results_20240808161952.json
│   ├── mistral_results_20240808161959.json
│   └── mistral_results_20240808162007.json
├── output-stage2-fewshot-nocot
│   ├── mistral_20240808161717.log
│   ├── mistral_20240808161831.log
│   ├── mistral_20240808161836.log
│   ├── mistral_20240808161844.log
│   ├── mistral_20240808161851.log
│   ├── mistral_results_20240808161717.json
│   ├── mistral_results_20240808161831.json
│   ├── mistral_results_20240808161836.json
│   ├── mistral_results_20240808161844.json
│   └── mistral_results_20240808161851.json
├── output-stage2-zeroshot-cot
│   ├── mistral_20240807213510.log
│   └── mistral_results_20240807213510.json
├── output-stage2-zeroshot-nocot
│   ├── mistral_20240807205945.log
│   └── mistral_results_20240807205945.json
├── README.md
├── test_case_id.txt
└── tree.txt
